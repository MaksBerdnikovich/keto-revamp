<div class="paypal-box panel" style="display:none;">
    <button class="paypal-btn" type="submit" href="#"><img src="<?php echo get_image_url('v2/paypal-btn.png') ?>">
    </button>
    <p class="click-txt">
    ...
    <img src="<?php echo get_image_url('v2/security-logo.png') ?>" class="security-logo">
</div>