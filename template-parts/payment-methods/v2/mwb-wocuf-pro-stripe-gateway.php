<div class="card-box panel">
    ...
    <input type="submit" value="Submit Secure Payment" id="stripe-submit-button" disabled="disabled" placeholder="Submit Secure Payment" class="comp-chk btn btn-primary btn-solid btn-xlarge" />
    ...
    <label class="checkbox-group">
        ...
        <span class="label">
            ...
            to receive information about Company name services, please send us an email at
