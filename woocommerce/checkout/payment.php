...
if (is_page_template('template-checkout-v1.php')) {
    get_template_part('template-parts/checkout-payment-v1', '', ['available_gateways' => $available_gateways]);
} elseif (is_page_template('template-checkout-v2.php')) {
    get_template_part('template-parts/checkout-payment-v2', '', ['available_gateways' => $available_gateways]);
} elseif (is_page_template('template-workouts.php')) {
    get_template_part('template-parts/checkout-payment-workouts', '', ['available_gateways' => $available_gateways]);
} elseif (is_page_template('template-upsell-plan.php')) {
    get_template_part('template-parts/checkout-payment-plan-upsell', '', ['available_gateways' => $available_gateways]);
}else { ?>
