...
<div class="single-page">
    <div class="container">
        <div class="back-link m-bottom-2">
            <a href="javascript:history.go(-1)"><i class="icon-next"></i> <span>Back</span></a>
        </div>

        <div class="page-text m-bottom-1">
            <div class="title-h3">Terms & Conditions</div>
        </div>

        <div class="page-text tx-repeat m-bottom-1">
            <p>
                Welcome to My Custom Meal Plan. If you continue to browse and use this website, you are agreeing to
                comply with and be bound by the following terms and conditions of use, which together with our privacy
                policy govern Custom Keto Diets relationship with you in relation to this website. If you disagree with
        ...
        <div class="styled-list small">
            <ul>
                ...
                <li>
                    <p>
                        This website uses cookies for the purpose of member access.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        The name Rachel Roberts is a pen name used by the author of Custom Keto Diet. Some videos contain a
                        paid spokesperson that are used to portray author.
                    </p>
                </li>
            </ul>
        </div>
        ...
        <div class="page-text">
            <p>
                Testimonials, case studies, and examples found on this page are results that have been forwarded to us
                by users of "Custom Keto Diet" products and related products, and may not reflect the typical
                purchaser's experience, may not apply to the average person and are not intended to represent or
